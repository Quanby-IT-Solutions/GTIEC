...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "group/calendar bg-background p-3 [--cell-radius:var(--radius-4xl)] [--cell-size:var(--spacing-8)] in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent",
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "h-[var(--cell-size)] p-0 select-none aria-disabled:opacity-50",
        ...
        caption_label: cn(
          ...
          captionLayout === "label"
            ? "text-sm"
            : "flex items-center gap-1 rounded-[var(--cell-radius)] text-sm [&>svg]:h-3.5 [&>svg]:w-3.5 [&>svg]:text-muted-foreground",
